...
export interface ScarCoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "mintThreshold",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setMintThreshold",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ScarCoin extends BaseContract {
  connect(runner?: ContractRunner | null): ScarCoin;
  waitForDeployment(): Promise<this>;

  interface: ScarCoinInterface;
  ...
  mintThreshold: TypedContractMethod<[], [bigint], "view">;
  ...
  setMintThreshold: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setMintThreshold"
